...
public class UserServiceGetLastCourse implements StringEvent {
    ...
    public String go()  {
        ...
        String result = null;
        try{
            stmt = prepareStatement("select e.eid as cid from examperm ep, exam e where ep.sid = ? and ep.eid = e.eid and e.iscontest=0 order by time desc");
        ...
        return  result == null ? "NOTHING" : result;
    }
